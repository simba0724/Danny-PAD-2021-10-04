      ...
      <template slot="front">
        <v-card
          ...
          <div class="text-center">
            ...
            <div class="farm-description" style="margin-bottom: 20px; margin-top:-10px">Liquidity Farm: 10% fee when staking and unstaking, <br> 7.5% goes back to the pool and 2.5% goes to the vault</div>
            <h5 class="stats-line">
              <img :src="farm_img">
              {{select}} Balance
            ...
            <h5 class="stats-line">
              <img :src="farm_img">
              LP tokens Price
              <span class="stats-line-info">{{round(lpPrice*1000, 4)}}/K</span>
            </h5>
            <v-divider style="margin-left: 2%; width: 96%;"></v-divider>
          </div>
          <v-row
  ...
  methods: {
    ...
    async loadInstances () {
      const loadWeb3 = setInterval(() => {
        ...
        else this.loadNewInstances(this.select)
