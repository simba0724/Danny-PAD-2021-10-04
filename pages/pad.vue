    ...
    cols="12">
      <div class="text-center">
        ...
        v-model="toggle_exclusive">
          ...
          <v-btn to="/pad" active-class='active-pad'>
            Pad
          </v-btn>
        </v-btn-toggle>
        <div style="margin-top: 62px;" class="pagelogo">
          <img src="/PadToad.svg" />
          <h1>Pad Farms</h1>
          <h5>Stake tokens to earn PAD, LP and partner tokens.</h5>
        </div>
      </div>
    </v-col>
    <filterlayout>
...
import FarmItem from '../components/PadFarmItem.vue'
...
<style scoped>
  ...
  .theme--dark.v-btn--active[data-v-2a183b29]:hover::before, .theme--dark.v-btn--active[data-v-2a183b29]::before {
    border-radius: 25px !important;
    margin: 0px;
  }
